...
X_sample_list, y_sample_list = create_sub_samples(x2,y2)
...
def main():
  round_number = 0
  file_path = 'meta_data_client_2.json'
  ...
  while True:
    ...
    if len(data)>1:
      ...
      if data == "Update":
        ...
        meta_data_client_2['round_number'] = round_number+1

        with open(file_path,'w') as f:
          json.dump(meta_data_client_2,f,indent=4)
